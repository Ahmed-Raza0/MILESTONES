...
import { useCart } from '../../context/CartContext';  // Use the useCart hook to access cart context
...
export default function Carddetails({ params }: { params: { id: string } }) {
  const { handleAddToCart, cart } = useCart();  // Accessing cart and add function from context
